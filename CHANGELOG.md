...
Full Changelog: [...abc-v0.0.1](https://github.com/Increase/increase-python/compare/...abc-v0.0.1)
...
* add `None` default value to nullable response properties ([#284](https://github.com/Increase/increase-python/issues/284)) ([3419789](https://github.com/Increase/increase-python/commit/3419789e994627d631a6053e8f29e67507c26ce4))
...
* add webhook support for node and python SDKs ([#308](https://github.com/Increase/increase-python/issues/308)) ([a6fffd9](https://github.com/Increase/increase-python/commit/a6fffd900f81aca42d082d5ef7ebc34899af3e19))
...
* **api:** add `ach_debit_status` ([#287](https://github.com/Increase/increase-python/issues/287)) ([cf994f0](https://github.com/Increase/increase-python/commit/cf994f077e1c6cc01007c09f7342d055210a94b7))
* **api:** add `suspected_fraud` rejection reason ([#265](https://github.com/Increase/increase-python/issues/265)) ([99807f0](https://github.com/Increase/increase-python/commit/99807f0367d720522c4584e720e2a2841725aa62))
...
* **api:** add deposit_submission property to check deposit ([#268](https://github.com/Increase/increase-python/issues/268)) ([ba7c3cb](https://github.com/Increase/increase-python/commit/ba7c3cbadd11e014060dd9f0673e0f7a98fe4d68))
...
* **api:** add failed to export status enum ([#198](https://github.com/Increase/increase-python/issues/198)) ([9493bab](https://github.com/Increase/increase-python/commit/9493babddc2373e11ca49c386a58ff0491f7254c))
...
* **api:** add merchant data to simulation api ([#293](https://github.com/Increase/increase-python/issues/293)) ([05160b3](https://github.com/Increase/increase-python/commit/05160b36c628b3087a956ab08e2377fea3e72bcf))
* **api:** add network identifiers and effective date ([#195](https://github.com/Increase/increase-python/issues/195)) ([1e35441](https://github.com/Increase/increase-python/commit/1e35441059b12b414fb50ceb1f98d5a700299348))
* **api:** add oauth token and inbound wire transfer methods ([#311](https://github.com/Increase/increase-python/issues/311)) ([3040732](https://github.com/Increase/increase-python/commit/3040732af0e177ac306d32bc8662ae167290ac01))
...
* **api:** add real-time payments request for payment endpoints ([#281](https://github.com/Increase/increase-python/issues/281)) ([b14e2e4](https://github.com/Increase/increase-python/commit/b14e2e44998deea1ec3211abae2af2bf1769b3e5))
...
* **api:** list Inbound Wire Transfers, change transfer simulation return types ([#316](https://github.com/Increase/increase-python/issues/316)) ([a88dbd4](https://github.com/Increase/increase-python/commit/a88dbd419d10b1f425aeba9194760cc59a0f9410))
...
* **api:** restructure balance lookups ([#211](https://github.com/Increase/increase-python/issues/211)) ([0cd9f6a](https://github.com/Increase/increase-python/commit/0cd9f6a59d95abb66fa66e131793946f2b7b8422))
* **api:** simplify WireDecline and InboundWireTransfer ([#312](https://github.com/Increase/increase-python/issues/312)) ([b57fee7](https://github.com/Increase/increase-python/commit/b57fee746ec20785f1f5ae206d06c44fc6aad9c3))
* **api:** split card profile resource into digital and physical card profile resources ([#335](https://github.com/Increase/increase-python/issues/335)) ([cc90d49](https://github.com/Increase/increase-python/commit/cc90d4970c47f1b87860f451b8549baad94f63de))
* **api:** update descriptions ([#321](https://github.com/Increase/increase-python/issues/321)) ([06ab481](https://github.com/Increase/increase-python/commit/06ab481a36521518b86ae09257cc6e3088f274b2))
...
* **api:** updates ([#257](https://github.com/Increase/increase-python/issues/257)) ([048c435](https://github.com/Increase/increase-python/commit/048c4350625207f345af88abac4e6413a67ec083))
...
* **client:** add support for streaming raw responses ([#294](https://github.com/Increase/increase-python/issues/294)) ([4e89d58](https://github.com/Increase/increase-python/commit/4e89d588b404feb6258c50ec2cf420c78016ce13))
...
* **client:** allow binary returns ([#199](https://github.com/Increase/increase-python/issues/199)) ([8eb2ea8](https://github.com/Increase/increase-python/commit/8eb2ea8beee57acd273dc994ab8d032203d108a9))
* **client:** enable follow redirects by default ([#317](https://github.com/Increase/increase-python/issues/317)) ([3a98538](https://github.com/Increase/increase-python/commit/3a9853877e4de3a40c8347c899fefb55ffd67629))
...
* **client:** support accessing raw response objects ([#191](https://github.com/Increase/increase-python/issues/191)) ([780292d](https://github.com/Increase/increase-python/commit/780292d7a663eb444e69fe304ffd15be4af60ac0))
* **client:** support parsing custom response types ([#322](https://github.com/Increase/increase-python/issues/322)) ([1084f06](https://github.com/Increase/increase-python/commit/1084f06efa5e3e5fad28b47d0317e1a4808bfc5e))
* **client:** support passing BaseModels to request params at runtime ([#201](https://github.com/Increase/increase-python/issues/201)) ([9bdca5d](https://github.com/Increase/increase-python/commit/9bdca5d43abfa8f3e151f534f97fb5b435237271))
* **client:** support passing chunk size for binary responses ([#214](https://github.com/Increase/increase-python/issues/214)) ([faf4411](https://github.com/Increase/increase-python/commit/faf4411d71dbde70145223f9902b192643f44a1b))
* **client:** support passing httpx.Timeout to method timeout argument ([#207](https://github.com/Increase/increase-python/issues/207)) ([6db1c2c](https://github.com/Increase/increase-python/commit/6db1c2c19aee766caa402b489e81ee6aff5a373e))
...
* **client:** support reading the base url from an env variable ([#226](https://github.com/Increase/increase-python/issues/226)) ([839f5c4](https://github.com/Increase/increase-python/commit/839f5c4bece5047ac9c414510ef6bdad8dd5ca30))
...
* **github:** include a devcontainer setup ([#196](https://github.com/Increase/increase-python/issues/196)) ([c3f67e1](https://github.com/Increase/increase-python/commit/c3f67e1cb54f068cb169fc99817e162186874ec8))
* **package:** add classifiers ([#194](https://github.com/Increase/increase-python/issues/194)) ([3a70101](https://github.com/Increase/increase-python/commit/3a70101c142deb6cb990a002f272457ec5e4b200))
...
* avoid leaking memory when Client.with_options is used ([#259](https://github.com/Increase/increase-python/issues/259)) ([bb9a07b](https://github.com/Increase/increase-python/commit/bb9a07bdfbc9d58c2406dc18993553808d5676e9))
* **binaries:** don't synchronously block in astream_to_file ([#202](https://github.com/Increase/increase-python/issues/202)) ([6e83655](https://github.com/Increase/increase-python/commit/6e8365599474416d8af6c02ef658ed4b36df66e4))
* **ci:** ignore stainless-app edits to release PR title ([#307](https://github.com/Increase/increase-python/issues/307)) ([8ad2e88](https://github.com/Increase/increase-python/commit/8ad2e889a17a1ba0652ba12a00f4668ce7580838))
...
* **client:** attempt to parse unknown json content types ([#229](https://github.com/Increase/increase-python/issues/229)) ([5ad26c4](https://github.com/Increase/increase-python/commit/5ad26c43cbcd4960cd7fc6af376ddc61b0abf5c6))
* **client:** correct base_url setter implementation ([#245](https://github.com/Increase/increase-python/issues/245)) ([5d8eb8a](https://github.com/Increase/increase-python/commit/5d8eb8aa55a291d77d93294b1bb57e53ffb98330))
...
* **client:** correctly use custom http client auth ([#278](https://github.com/Increase/increase-python/issues/278)) ([d6db31c](https://github.com/Increase/increase-python/commit/d6db31c96e174ebd885fa891f02c9735ccb2fe7b))
...
* **client:** ensure path params are non-empty ([#297](https://github.com/Increase/increase-python/issues/297)) ([51363eb](https://github.com/Increase/increase-python/commit/51363eb67bc38dd350a59603d978f34f19e34c3f))
* **client:** ensure retried requests are closed ([#240](https://github.com/Increase/increase-python/issues/240)) ([c6e3901](https://github.com/Increase/increase-python/commit/c6e39014f3611e26549e2ad98abc23b5ae9f41ad))
...
* **client:** retry if SSLWantReadError occurs in the async client ([#220](https://github.com/Increase/increase-python/issues/220)) ([3c3c8d4](https://github.com/Increase/increase-python/commit/3c3c8d4487f18f271a6a1c137b10b8a8f9bce8f1))
* **client:** serialise pydantic v1 default fields correctly in params ([#218](https://github.com/Increase/increase-python/issues/218)) ([e31fc45](https://github.com/Increase/increase-python/commit/e31fc451c9bf8a3ac9c8e42aa459c1a0e7584a5f))
...
* **errors:** properly assign APIError.body ([#256](https://github.com/Increase/increase-python/issues/256)) ([b6b309c](https://github.com/Increase/increase-python/commit/b6b309c9a6159c7f3ba271bdd948d67521c079c4))
* **models:** mark unknown fields as set in pydantic v1 ([#217](https://github.com/Increase/increase-python/issues/217)) ([bf0db9f](https://github.com/Increase/increase-python/commit/bf0db9fd60908bd4a130ce2663892e4470345738))
* prevent crash when platform.architecture() is not allowed ([#327](https://github.com/Increase/increase-python/issues/327)) ([83ae9f4](https://github.com/Increase/increase-python/commit/83ae9f4e9ae6a3dfab376dba7838e0074dbf72b9))
* prevent TypeError in Python 3.8 (ABC is not subscriptable) ([#206](https://github.com/Increase/increase-python/issues/206)) ([7b1c56e](https://github.com/Increase/increase-python/commit/7b1c56e2e2f24568dfc2f30680f2be589b73f28d))
...
* **types:** loosen most List params types to Iterable ([#331](https://github.com/Increase/increase-python/issues/331)) ([4fd83d0](https://github.com/Increase/increase-python/commit/4fd83d05a3a69254f66101726fe66b1009a18dec))


### Code Refactoring

* fix oauth casing ([#310](https://github.com/Increase/increase-python/issues/310)) ([889cd01](https://github.com/Increase/increase-python/commit/889cd01370790d417225bee4e1090aa9840ac81f))
