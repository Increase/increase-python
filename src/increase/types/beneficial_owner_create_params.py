...
__all__ = [
    ...
    "IndividualIdentificationDriversLicense",
    "IndividualIdentificationOther",
    "IndividualIdentificationPassport",
]
...
class IndividualIdentificationDriversLicense(TypedDict, total=False):
...
class IndividualIdentificationOther(TypedDict, total=False):
...
class IndividualIdentificationPassport(TypedDict, total=False):
...
class IndividualIdentification(TypedDict, total=False, extra_items=object):  # type: ignore[call-arg]
    ...
    other: IndividualIdentificationOther
    """Information about the identification document provided.

    Required if `method` is equal to `other`.
    """

    passport: IndividualIdentificationPassport
    """Information about the passport used for identification.
...
class Individual(TypedDict, total=False):
    ...
    identification: Required[IndividualIdentification]
    """A means of verifying the person's identity."""
