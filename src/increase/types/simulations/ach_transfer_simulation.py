...
class TransactionSource(BaseModel):
    ...
    check_transfer_intention: Optional[TransactionSourceCheckTransferIntention] = None
    ...
    inbound_check: Optional[TransactionSourceInboundCheck] = None
...
class TransferAddenda(BaseModel):
    ...
    freeform: Optional[TransferAddendaFreeform] = None
    """Unstructured `payment_related_information` passed through by the originator."""
...
class Transfer(BaseModel):
    ...
    addenda: Optional[TransferAddenda] = None
    """Additional information sent from the originator."""
    ...
    decline: Optional[TransferDecline] = None
    ...
    notification_of_change: Optional[TransferNotificationOfChange] = None
    """
    ...
    transfer_return: Optional[TransferTransferReturn] = None
