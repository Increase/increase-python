...
class ACHTransfersResource(SyncAPIResource):
    ...
    def create_notification_of_change(
        ...
        *,
        ...
        Args:
          ...
          corrected_account_funding: The corrected account funding type.
          ...
          corrected_individual_id: The corrected individual identifier.

          corrected_routing_number: The corrected routing number.
        ...
        return self._post(
            ...
            body=maybe_transform(
                {
                    "corrected_account_funding": corrected_account_funding,
                    "corrected_account_number": corrected_account_number,
                    "corrected_individual_id": corrected_individual_id,
    ...
    def settle(
        ...
        ach_transfer_id: str,
        *,
        inbound_funds_hold_behavior: Literal["release_immediately", "release_on_default_schedule"] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
