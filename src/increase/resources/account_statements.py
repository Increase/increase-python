...
class AccountStatementsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/account_statements/{account_statement_id}", account_statement_id=account_statement_id),
    ...
    def list(
        ...
        *,
        ...
        limit: int | Omit = omit,
        statement_period_start: account_statement_list_params.StatementPeriodStart | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
