...
class PendingTransactionsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/pending_transactions/{pending_transaction_id}", pending_transaction_id=pending_transaction_id
            ),
            options=make_request_options(
    ...
    def release(
        ...
        *,
        ...
        return self._post(
            path_template(
                "/pending_transactions/{pending_transaction_id}/release", pending_transaction_id=pending_transaction_id
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
