...
class DeclinedTransactionsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/declined_transactions/{declined_transaction_id}", declined_transaction_id=declined_transaction_id
            ),
    ...
    def list(
        ...
        *,
        ...
        category: declined_transaction_list_params.Category | Omit = omit,
        created_at: declined_transaction_list_params.CreatedAt | Omit = omit,
