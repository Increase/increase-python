...
class InboundRealTimePaymentsTransfersResource(SyncAPIResource):
        ...
        *,
        ...
        return self._get(
            path_template(
                ...
                inbound_real_time_payments_transfer_id=inbound_real_time_payments_transfer_id,
            ),
    ...
    def list(
        ...
        *,
        ...
        created_at: inbound_real_time_payments_transfer_list_params.CreatedAt | Omit = omit,
