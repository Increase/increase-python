...
class FednowTransfersResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/fednow_transfers/{fednow_transfer_id}", fednow_transfer_id=fednow_transfer_id),
            options=make_request_options(
    ...
    def approve(
        ...
        *,
        ...
        if not fednow_transfer_id:
            raise ValueError(f"Expected a non-empty value for `fednow_transfer_id` but received {fednow_transfer_id!r}")
        return self._post(
            path_template("/fednow_transfers/{fednow_transfer_id}/approve", fednow_transfer_id=fednow_transfer_id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def cancel(
        ...
        *,
        ...
        if not fednow_transfer_id:
            raise ValueError(f"Expected a non-empty value for `fednow_transfer_id` but received {fednow_transfer_id!r}")
        return self._post(
            path_template("/fednow_transfers/{fednow_transfer_id}/cancel", fednow_transfer_id=fednow_transfer_id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
