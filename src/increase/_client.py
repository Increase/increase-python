...
__all__ = ["ENVIRONMENTS", "Timeout", "Transport", "ProxiesTypes", "RequestOptions", "resources", "Increase", "AsyncIncrease", "Client", "AsyncClient"]
...
class Increase(SyncAPIClient):
    ...
    def __init__(self, *, api_key: str | None = None, webhook_secret: str | None = None, environment: Literal["production","sandbox"] | NotGiven = NOT_GIVEN, base_url: str | httpx.URL | None | NotGiven = NOT_GIVEN, timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN, max_retries: int = DEFAULT_MAX_RETRIES, default_headers: Mapping[str, str] | None = None, default_query: Mapping[str, object] | None = None, 
...
class AsyncIncrease(AsyncAPIClient):
    ...
    _strict_response_validation: bool = False) -> None:
        ...
        self.proof_of_authorization_request_submissions = resources.AsyncProofOfAuthorizationRequestSubmissionsResource(self)
...
class IncreaseWithRawResponse:
    def __init__(self, client: Increase) -> None:
        ...
        self.card_purchase_supplements = resources.CardPurchaseSupplementsResourceWithRawResponse(client.card_purchase_supplements)
        ...
        self.physical_card_profiles = resources.PhysicalCardProfilesResourceWithRawResponse(client.physical_card_profiles)
        ...
        self.inbound_wire_transfers = resources.InboundWireTransfersResourceWithRawResponse(client.inbound_wire_transfers)
        self.wire_drawdown_requests = resources.WireDrawdownRequestsResourceWithRawResponse(client.wire_drawdown_requests)
        self.inbound_wire_drawdown_requests = resources.InboundWireDrawdownRequestsResourceWithRawResponse(client.inbound_wire_drawdown_requests)
        self.check_transfers = resources.CheckTransfersResourceWithRawResponse(client.check_transfers)
        self.inbound_check_deposits = resources.InboundCheckDepositsResourceWithRawResponse(client.inbound_check_deposits)
        self.real_time_payments_transfers = resources.RealTimePaymentsTransfersResourceWithRawResponse(client.real_time_payments_transfers)
        ...
        self.supplemental_documents = resources.SupplementalDocumentsResourceWithRawResponse(client.supplemental_documents)
        self.programs = resources.ProgramsResourceWithRawResponse(client.programs)
        self.proof_of_authorization_requests = resources.ProofOfAuthorizationRequestsResourceWithRawResponse(client.proof_of_authorization_requests)
        self.proof_of_authorization_request_submissions = resources.ProofOfAuthorizationRequestSubmissionsResourceWithRawResponse(client.proof_of_authorization_request_submissions)
        ...
        self.bookkeeping_entry_sets = resources.BookkeepingEntrySetsResourceWithRawResponse(client.bookkeeping_entry_sets)
        ...
        self.intrafi_account_enrollments = resources.IntrafiAccountEnrollmentsResourceWithRawResponse(client.intrafi_account_enrollments)
        ...
        self.real_time_payments_request_for_payments = resources.RealTimePaymentsRequestForPaymentsResourceWithRawResponse(client.real_time_payments_request_for_payments)
...
class AsyncIncreaseWithRawResponse:
    def __init__(self, client: AsyncIncrease) -> None:
        ...
        self.card_purchase_supplements = resources.AsyncCardPurchaseSupplementsResourceWithRawResponse(client.card_purchase_supplements)
        ...
        self.digital_card_profiles = resources.AsyncDigitalCardProfilesResourceWithRawResponse(client.digital_card_profiles)
        self.physical_card_profiles = resources.AsyncPhysicalCardProfilesResourceWithRawResponse(client.physical_card_profiles)
        self.digital_wallet_tokens = resources.AsyncDigitalWalletTokensResourceWithRawResponse(client.digital_wallet_tokens)
        self.transactions = resources.AsyncTransactionsResourceWithRawResponse(client.transactions)
        self.pending_transactions = resources.AsyncPendingTransactionsResourceWithRawResponse(client.pending_transactions)
        self.declined_transactions = resources.AsyncDeclinedTransactionsResourceWithRawResponse(client.declined_transactions)
        ...
        self.ach_prenotifications = resources.AsyncACHPrenotificationsResourceWithRawResponse(client.ach_prenotifications)
        self.inbound_ach_transfers = resources.AsyncInboundACHTransfersResourceWithRawResponse(client.inbound_ach_transfers)
        self.wire_transfers = resources.AsyncWireTransfersResourceWithRawResponse(client.wire_transfers)
        self.inbound_wire_transfers = resources.AsyncInboundWireTransfersResourceWithRawResponse(client.inbound_wire_transfers)
        self.wire_drawdown_requests = resources.AsyncWireDrawdownRequestsResourceWithRawResponse(client.wire_drawdown_requests)
        self.inbound_wire_drawdown_requests = resources.AsyncInboundWireDrawdownRequestsResourceWithRawResponse(client.inbound_wire_drawdown_requests)
        self.check_transfers = resources.AsyncCheckTransfersResourceWithRawResponse(client.check_transfers)
        self.inbound_check_deposits = resources.AsyncInboundCheckDepositsResourceWithRawResponse(client.inbound_check_deposits)
        self.real_time_payments_transfers = resources.AsyncRealTimePaymentsTransfersResourceWithRawResponse(client.real_time_payments_transfers)
        ...
        self.supplemental_documents = resources.AsyncSupplementalDocumentsResourceWithRawResponse(client.supplemental_documents)
        self.programs = resources.AsyncProgramsResourceWithRawResponse(client.programs)
        self.proof_of_authorization_requests = resources.AsyncProofOfAuthorizationRequestsResourceWithRawResponse(client.proof_of_authorization_requests)
        self.proof_of_authorization_request_submissions = resources.AsyncProofOfAuthorizationRequestSubmissionsResourceWithRawResponse(client.proof_of_authorization_request_submissions)
        ...
        self.bookkeeping_accounts = resources.AsyncBookkeepingAccountsResourceWithRawResponse(client.bookkeeping_accounts)
        self.bookkeeping_entry_sets = resources.AsyncBookkeepingEntrySetsResourceWithRawResponse(client.bookkeeping_entry_sets)
        ...
        self.intrafi_account_enrollments = resources.AsyncIntrafiAccountEnrollmentsResourceWithRawResponse(client.intrafi_account_enrollments)
        ...
        self.real_time_payments_request_for_payments = resources.AsyncRealTimePaymentsRequestForPaymentsResourceWithRawResponse(client.real_time_payments_request_for_payments)
...
class IncreaseWithStreamedResponse:
    def __init__(self, client: Increase) -> None:
        ...
        self.card_purchase_supplements = resources.CardPurchaseSupplementsResourceWithStreamingResponse(client.card_purchase_supplements)
        ...
        self.digital_card_profiles = resources.DigitalCardProfilesResourceWithStreamingResponse(client.digital_card_profiles)
        self.physical_card_profiles = resources.PhysicalCardProfilesResourceWithStreamingResponse(client.physical_card_profiles)
        self.digital_wallet_tokens = resources.DigitalWalletTokensResourceWithStreamingResponse(client.digital_wallet_tokens)
        self.transactions = resources.TransactionsResourceWithStreamingResponse(client.transactions)
        self.pending_transactions = resources.PendingTransactionsResourceWithStreamingResponse(client.pending_transactions)
        self.declined_transactions = resources.DeclinedTransactionsResourceWithStreamingResponse(client.declined_transactions)
        ...
        self.ach_prenotifications = resources.ACHPrenotificationsResourceWithStreamingResponse(client.ach_prenotifications)
        self.inbound_ach_transfers = resources.InboundACHTransfersResourceWithStreamingResponse(client.inbound_ach_transfers)
        self.wire_transfers = resources.WireTransfersResourceWithStreamingResponse(client.wire_transfers)
        self.inbound_wire_transfers = resources.InboundWireTransfersResourceWithStreamingResponse(client.inbound_wire_transfers)
        self.wire_drawdown_requests = resources.WireDrawdownRequestsResourceWithStreamingResponse(client.wire_drawdown_requests)
        self.inbound_wire_drawdown_requests = resources.InboundWireDrawdownRequestsResourceWithStreamingResponse(client.inbound_wire_drawdown_requests)
        self.check_transfers = resources.CheckTransfersResourceWithStreamingResponse(client.check_transfers)
        self.inbound_check_deposits = resources.InboundCheckDepositsResourceWithStreamingResponse(client.inbound_check_deposits)
        self.real_time_payments_transfers = resources.RealTimePaymentsTransfersResourceWithStreamingResponse(client.real_time_payments_transfers)
        ...
        self.supplemental_documents = resources.SupplementalDocumentsResourceWithStreamingResponse(client.supplemental_documents)
        self.programs = resources.ProgramsResourceWithStreamingResponse(client.programs)
        self.proof_of_authorization_requests = resources.ProofOfAuthorizationRequestsResourceWithStreamingResponse(client.proof_of_authorization_requests)
        self.proof_of_authorization_request_submissions = resources.ProofOfAuthorizationRequestSubmissionsResourceWithStreamingResponse(client.proof_of_authorization_request_submissions)
        ...
        self.bookkeeping_accounts = resources.BookkeepingAccountsResourceWithStreamingResponse(client.bookkeeping_accounts)
        self.bookkeeping_entry_sets = resources.BookkeepingEntrySetsResourceWithStreamingResponse(client.bookkeeping_entry_sets)
        ...
        self.intrafi_account_enrollments = resources.IntrafiAccountEnrollmentsResourceWithStreamingResponse(client.intrafi_account_enrollments)
        ...
        self.real_time_payments_request_for_payments = resources.RealTimePaymentsRequestForPaymentsResourceWithStreamingResponse(client.real_time_payments_request_for_payments)
...
class AsyncIncreaseWithStreamedResponse:
    def __init__(self, client: AsyncIncrease) -> None:
        ...
        self.card_purchase_supplements = resources.AsyncCardPurchaseSupplementsResourceWithStreamingResponse(client.card_purchase_supplements)
        ...
        self.digital_card_profiles = resources.AsyncDigitalCardProfilesResourceWithStreamingResponse(client.digital_card_profiles)
        self.physical_card_profiles = resources.AsyncPhysicalCardProfilesResourceWithStreamingResponse(client.physical_card_profiles)
        self.digital_wallet_tokens = resources.AsyncDigitalWalletTokensResourceWithStreamingResponse(client.digital_wallet_tokens)
        self.transactions = resources.AsyncTransactionsResourceWithStreamingResponse(client.transactions)
        self.pending_transactions = resources.AsyncPendingTransactionsResourceWithStreamingResponse(client.pending_transactions)
        self.declined_transactions = resources.AsyncDeclinedTransactionsResourceWithStreamingResponse(client.declined_transactions)
        ...
        self.ach_prenotifications = resources.AsyncACHPrenotificationsResourceWithStreamingResponse(client.ach_prenotifications)
        self.inbound_ach_transfers = resources.AsyncInboundACHTransfersResourceWithStreamingResponse(client.inbound_ach_transfers)
        self.wire_transfers = resources.AsyncWireTransfersResourceWithStreamingResponse(client.wire_transfers)
        self.inbound_wire_transfers = resources.AsyncInboundWireTransfersResourceWithStreamingResponse(client.inbound_wire_transfers)
        self.wire_drawdown_requests = resources.AsyncWireDrawdownRequestsResourceWithStreamingResponse(client.wire_drawdown_requests)
        self.inbound_wire_drawdown_requests = resources.AsyncInboundWireDrawdownRequestsResourceWithStreamingResponse(client.inbound_wire_drawdown_requests)
        self.check_transfers = resources.AsyncCheckTransfersResourceWithStreamingResponse(client.check_transfers)
        self.inbound_check_deposits = resources.AsyncInboundCheckDepositsResourceWithStreamingResponse(client.inbound_check_deposits)
        self.real_time_payments_transfers = resources.AsyncRealTimePaymentsTransfersResourceWithStreamingResponse(client.real_time_payments_transfers)
        ...
        self.inbound_mail_items = resources.AsyncInboundMailItemsResourceWithStreamingResponse(client.inbound_mail_items)
        ...
        self.supplemental_documents = resources.AsyncSupplementalDocumentsResourceWithStreamingResponse(client.supplemental_documents)
        self.programs = resources.AsyncProgramsResourceWithStreamingResponse(client.programs)
        self.proof_of_authorization_requests = resources.AsyncProofOfAuthorizationRequestsResourceWithStreamingResponse(client.proof_of_authorization_requests)
        self.proof_of_authorization_request_submissions = resources.AsyncProofOfAuthorizationRequestSubmissionsResourceWithStreamingResponse(client.proof_of_authorization_request_submissions)
        self.account_statements = resources.AsyncAccountStatementsResourceWithStreamingResponse(client.account_statements)
        ...
        self.event_subscriptions = resources.AsyncEventSubscriptionsResourceWithStreamingResponse(client.event_subscriptions)
        self.real_time_decisions = resources.AsyncRealTimeDecisionsResourceWithStreamingResponse(client.real_time_decisions)
        self.bookkeeping_accounts = resources.AsyncBookkeepingAccountsResourceWithStreamingResponse(client.bookkeeping_accounts)
        self.bookkeeping_entry_sets = resources.AsyncBookkeepingEntrySetsResourceWithStreamingResponse(client.bookkeeping_entry_sets)
        self.bookkeeping_entries = resources.AsyncBookkeepingEntriesResourceWithStreamingResponse(client.bookkeeping_entries)
        ...
        self.intrafi_account_enrollments = resources.AsyncIntrafiAccountEnrollmentsResourceWithStreamingResponse(client.intrafi_account_enrollments)
        self.intrafi_balances = resources.AsyncIntrafiBalancesResourceWithStreamingResponse(client.intrafi_balances)
        self.intrafi_exclusions = resources.AsyncIntrafiExclusionsResourceWithStreamingResponse(client.intrafi_exclusions)
        self.real_time_payments_request_for_payments = resources.AsyncRealTimePaymentsRequestForPaymentsResourceWithStreamingResponse(client.real_time_payments_request_for_payments)
