...
class PendingTransactions(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> PendingTransaction:
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[PendingTransaction]:
        """
        Args:
...
class AsyncPendingTransactions(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[PendingTransaction, AsyncPage[PendingTransaction]]:
        """
        Args:
          cursor: Return the page of entries after this one.
