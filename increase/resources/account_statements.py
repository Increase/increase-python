...
class AccountStatements(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> AccountStatement:
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[AccountStatement]:
        """
        Args:
    ...
    *,
    ...
    def list(self,
    query: AccountStatementListParams | None = None,
    *,
    cursor: str | NotGiven = NOT_GIVEN,
    limit: int | NotGiven = NOT_GIVEN,
    account_id: str | NotGiven = NOT_GIVEN,
    ...
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[AccountStatement]:
        ...
        if query is not None:
          ...
          # with the standard AccountStatementListParams type.
          query = cast(Any, {
            "cursor": cursor,
            "limit": limit,
...
class AsyncAccountStatements(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[AccountStatement, AsyncPage[AccountStatement]]:
        """
        Args:
          cursor: Return the page of entries after this one.
