...
from ..types import ach_prenotification_create_params
...
class ACHPrenotifications(SyncAPIResource):
    ...
    *,
    ...
    routing_number: str,
    standard_entry_class_code: Literal["corporate_credit_or_debit", "prearranged_payments_and_deposit", "internet_initiated"] | NotGiven = NOT_GIVEN,
    ...
    query: Optional[Query] = None,) -> ACHPrenotification:
        """
        Args:
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[ACHPrenotification]:
        """
        Args:
...
class AsyncACHPrenotifications(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[ACHPrenotification, AsyncPage[ACHPrenotification]]:
        """
        Args:
          cursor: Return the page of entries after this one.
