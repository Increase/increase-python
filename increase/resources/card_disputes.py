...
from ..types import card_dispute_create_params
...
class CardDisputes(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> CardDispute:
        """Args:
    ...
    *,
    ...
    @required_args(["body"], ["disputed_transaction_id", "explanation"])
    def create(self,
    body: CardDisputeCreateParams | None = None,
    *,
    disputed_transaction_id: str | NotGiven = NOT_GIVEN,
    ...
    query: Optional[Query] = None,) -> CardDispute:
        ...
        if body is not None:
          ...
          # with the standard CardDisputeCreateParams type.
          body = cast(Any, {
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[CardDispute]:
        """
        Args:
    ...
    *,
    ...
    def list(self,
    query: CardDisputeListParams | None = None,
    *,
    cursor: str | NotGiven = NOT_GIVEN,
    limit: int | NotGiven = NOT_GIVEN,
    created_at: card_dispute_list_params.CreatedAt | NotGiven = NOT_GIVEN,
    ...
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[CardDispute]:
        ...
        if query is not None:
          ...
          # cast to Any is required because the NotGiven types make this expression incompatible
          # with the standard CardDisputeListParams type.
          query = cast(Any, {
            "cursor": cursor,
            "limit": limit,
...
class AsyncCardDisputes(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[CardDispute, AsyncPage[CardDispute]]:
        """
        Args:
          cursor: Return the page of entries after this one.
