...
from ...types.simulations import ach_transfer_create_inbound_params
from ...types.simulations.ach_transfer_create_inbound_params import ACHTransferCreateInboundParams
...
class ACHTransfers(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> ACHTransferSimulation:
