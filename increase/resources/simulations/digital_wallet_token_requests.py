...
from ...types.simulations.digital_wallet_token_request_create_params import DigitalWalletTokenRequestCreateParams
...
class DigitalWalletTokenRequests(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> shared.InboundDigitalWalletTokenRequestSimulationResult:
        """
