...
from ...types.simulations.inbound_real_time_payments_transfer_simulation_result import InboundRealTimePaymentsTransferSimulationResult
from ...types.simulations import real_time_payments_transfer_create_inbound_params
from ...types.simulations.real_time_payments_transfer_create_inbound_params import RealTimePaymentsTransferCreateInboundParams
...
class RealTimePaymentsTransfers(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> InboundRealTimePaymentsTransferSimulationResult:
        """
