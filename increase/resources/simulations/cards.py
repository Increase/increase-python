...
from ...types.simulations.card_authorization_simulation import CardAuthorizationSimulation
from ...types.simulations.transaction import Transaction
from ...types.simulations import card_authorize_params
from ...types.simulations.card_authorize_params import CardAuthorizeParams
from ...types.simulations import card_settlement_params
...
class Cards(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> CardAuthorizationSimulation:
        """
    ...
    *,
    ...
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,
    query: Optional[Query] = None,) -> Transaction:
        """
