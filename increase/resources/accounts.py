...
class Accounts(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> Account:
        """
        Args:
    ...
    *,
    ...
    query: Optional[Query] = None,) -> Account:
        ...
        if body is not None:
          ...
          # with the standard AccountCreateParams type.
          body = cast(Any, {
            "entity_id": entity_id,
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[Account]:
        """
        Args:
...
class AsyncAccounts(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[Account, AsyncPage[Account]]:
        """
        Args:
          cursor: Return the page of entries after this one.
