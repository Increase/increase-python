...
class ExternalAccounts(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> ExternalAccount:
        """
        Args:
    ...
    *,
    ...
    @required_args(["body"], ["routing_number", "account_number", "description"])
    def create(self,
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[ExternalAccount]:
        """
        Args:
...
class AsyncExternalAccounts(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[ExternalAccount, AsyncPage[ExternalAccount]]:
        """
        Args:
          cursor: Return the page of entries after this one.
