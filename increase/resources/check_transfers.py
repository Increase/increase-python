...
from ..types import check_transfer_create_params
...
class CheckTransfers(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> CheckTransfer:
        """
        Args:
    ...
    *,
    ...
    @required_args(["body"], ["account_id", "address_line1", "address_city", "address_state", "address_zip", "amount", "message", "recipient_name"])
    def create(self,
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[CheckTransfer]:
        """
        Args:
...
class AsyncCheckTransfers(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[CheckTransfer, AsyncPage[CheckTransfer]]:
        """
        Args:
          cursor: Return the page of entries after this one.
