...
from ..types import ach_transfer_create_params
...
class ACHTransfers(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> ACHTransfer:
        """
        Args:
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[ACHTransfer]:
        """
        Args:
...
class AsyncACHTransfers(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[ACHTransfer, AsyncPage[ACHTransfer]]:
        """
        Args:
          cursor: Return the page of entries after this one.
