...
from ..types import account_transfer_create_params
...
class AccountTransfers(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> AccountTransfer:
        """
        Args:
    ...
    *,
    ...
    @required_args(["body"], ["account_id", "amount", "description", "destination_account_id"])
    def create(self,
    body: AccountTransferCreateParams | None = None,
    *,
    account_id: str | NotGiven = NOT_GIVEN,
    amount: int | NotGiven = NOT_GIVEN,
    description: str | NotGiven = NOT_GIVEN,
    destination_account_id: str | NotGiven = NOT_GIVEN,
    # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
    # The extra values given here take precedence over values defined on the client or passed to this method.
    extra_headers: Headers | None = None,
    extra_query: Query | None = None,
    ...
    query: Optional[Query] = None,) -> AccountTransfer:
        ...
        if body is not None:
          ...
          # with the standard AccountTransferCreateParams type.
          body = cast(Any, {
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[AccountTransfer]:
        """
        Args:
    ...
    *,
    ...
    def list(self,
    query: AccountTransferListParams | None = None,
    *,
    cursor: str | NotGiven = NOT_GIVEN,
    limit: int | NotGiven = NOT_GIVEN,
    account_id: str | NotGiven = NOT_GIVEN,
    ...
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[AccountTransfer]:
        ...
        if query is not None:
          ...
          # cast to Any is required because the NotGiven types make this expression incompatible
          # with the standard AccountTransferListParams type.
          query = cast(Any, {
            "cursor": cursor,
            "limit": limit,
            "account_id": account_id,
...
class AsyncAccountTransfers(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[AccountTransfer, AsyncPage[AccountTransfer]]:
        """
        Args:
          cursor: Return the page of entries after this one.
