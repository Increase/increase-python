...
class EventSubscriptions(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> EventSubscription:
        """
        Args:
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[EventSubscription]:
        """
        Args:
...
class AsyncEventSubscriptions(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[EventSubscription, AsyncPage[EventSubscription]]:
        """
        Args:
          cursor: Return the page of entries after this one.
