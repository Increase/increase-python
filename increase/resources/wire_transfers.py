...
class WireTransfers(SyncAPIResource):
    def create(
        ...
        *,
        ...
        return self._post(
            "/wire_transfers",
            body=maybe_transform(body, WireTransferCreateParams),
            options=options,
    ...
    def list(
        ...
        *,
        ...
        options = make_request_options(headers, max_retries, timeout, maybe_transform(query, WireTransferListParams))
