...
from ..types import wire_transfer_create_params
...
class WireTransfers(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> WireTransfer:
        """
        Args:
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[WireTransfer]:
        """
        Args:
...
class AsyncWireTransfers(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[WireTransfer, AsyncPage[WireTransfer]]:
        """
        Args:
          cursor: Return the page of entries after this one.
