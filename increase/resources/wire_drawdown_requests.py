...
from ..types import wire_drawdown_request_create_params
from ..types.wire_drawdown_request_create_params import WireDrawdownRequestCreateParams
from ..types import wire_drawdown_request_list_params
...
class WireDrawdownRequests(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> WireDrawdownRequest:
        """
        Args:
    ...
    *,
    ...
    @required_args(["body"], ["account_number_id", "amount", "message_to_recipient", "recipient_account_number", "recipient_routing_number"])
    def create(self,
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[WireDrawdownRequest]:
        """
        Args:
...
class AsyncWireDrawdownRequests(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[WireDrawdownRequest, AsyncPage[WireDrawdownRequest]]:
        """
        Args:
          cursor: Return the page of entries after this one.
