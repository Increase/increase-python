...
class Entities(SyncAPIResource):
    ...
    *,
    ...
    query: Optional[Query] = None,) -> Entity:
        """
        Args:
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> SyncPage[Entity]:
        """
        Args:
...
class AsyncEntities(AsyncAPIResource):
    ...
    *,
    ...
    headers: Union[Headers, NotGiven] = NOT_GIVEN,
    max_retries: Union[int, NotGiven] = NOT_GIVEN,
    timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN,) -> AsyncPaginator[Entity, AsyncPage[Entity]]:
        """
        Args:
          cursor: Return the page of entries after this one.
