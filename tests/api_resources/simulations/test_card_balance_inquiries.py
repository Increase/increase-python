...
class TestCardBalanceInquiries:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_create(self, client: Increase) -> None:
        card_balance_inquiry = client.simulations.card_balance_inquiries.create()
...
class TestAsyncCardBalanceInquiries:
    ...
    async def test_method_create(self, async_client: AsyncIncrease) -> None:
        card_balance_inquiry = await async_client.simulations.card_balance_inquiries.create()
        assert_matches_type(CardPayment, card_balance_inquiry, path=["response"])
