...
class TestAsyncDeclinedTransactions:
    ...
    async def test_raw_response_retrieve(self, client: AsyncIncrease) -> None:
        response = await client.declined_transactions.with_raw_response.retrieve(
            "string",
        )
    ...
    async def test_streaming_response_retrieve(self, client: AsyncIncrease) -> None:
        async with client.declined_transactions.with_streaming_response.retrieve(
            "string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, client: AsyncIncrease) -> None:
        with pytest.raises(
            ...
            await client.declined_transactions.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_raw_response_list(self, client: AsyncIncrease) -> None:
        response = await client.declined_transactions.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, client: AsyncIncrease) -> None:
        async with client.declined_transactions.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
