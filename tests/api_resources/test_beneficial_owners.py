...
class TestBeneficialOwners:
    ...
    def test_raw_response_create(self, client: Increase) -> None:
        response = client.beneficial_owners.with_raw_response.create(
            entity_id="entity_n8y8tnk2p9339ti393yi",
            individual={
                "address": {
                    "city": "New York",
    ...
    def test_streaming_response_create(self, client: Increase) -> None:
        with client.beneficial_owners.with_streaming_response.create(
            entity_id="entity_n8y8tnk2p9339ti393yi",
            individual={
                "address": {
                    "city": "New York",
...
class TestAsyncBeneficialOwners:
    ...
    async def test_method_create(self, async_client: AsyncIncrease) -> None:
        beneficial_owner = await async_client.beneficial_owners.create(
            entity_id="entity_n8y8tnk2p9339ti393yi",
            individual={
                "address": {
                    "city": "New York",
    ...
    async def test_raw_response_create(self, async_client: AsyncIncrease) -> None:
        response = await async_client.beneficial_owners.with_raw_response.create(
            entity_id="entity_n8y8tnk2p9339ti393yi",
            individual={
                "address": {
                    "city": "New York",
    ...
    async def test_streaming_response_create(self, async_client: AsyncIncrease) -> None:
        async with async_client.beneficial_owners.with_streaming_response.create(
            entity_id="entity_n8y8tnk2p9339ti393yi",
            individual={
                "address": {
                    "city": "New York",
