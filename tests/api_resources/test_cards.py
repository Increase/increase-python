...
class TestCards:
    ...
    @parametrize
    def test_method_update_pin(self, client: Increase) -> None:
    ...
    @parametrize
    def test_raw_response_update_pin(self, client: Increase) -> None:
    ...
    @parametrize
    def test_streaming_response_update_pin(self, client: Increase) -> None:
    ...
    @parametrize
    def test_path_params_update_pin(self, client: Increase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `card_id` but received ''"):
...
class TestAsyncCards:
    ...
    @parametrize
    async def test_method_update_pin(self, async_client: AsyncIncrease) -> None:
    ...
    @parametrize
    async def test_raw_response_update_pin(self, async_client: AsyncIncrease) -> None:
    ...
    @parametrize
    async def test_streaming_response_update_pin(self, async_client: AsyncIncrease) -> None:
    ...
    @parametrize
    async def test_path_params_update_pin(self, async_client: AsyncIncrease) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `card_id` but received ''"):
